...
public class TankController {
	...
	private final int NUMOFEPOCHS = 50;
	...
	private final int numOfInputsPerNeuron = 4;
	...
	private final int resetMines   = 10;
...
//		remainingMines = mines.size();
		...
		for(int cnt = 0; cnt < numOfTanks; ++cnt){
			...
			newTank.setClosestMine(newTank.closest_mine(mines),mines);
			tanks.add(newTank);
		}
		

		
		// enable keyboard input for manual play
  //      addKeyListener(this);
  //      setFocusable(true);
...
//					tank.setClosestMine(tank.closest_mine(mines),mines);
					--remainingMines;
				}
